...
//! as `compass://settings/open` opens it), the community links, and
...
pub const ITEM_ID: &str = "org.tunaos.compass";

/// The themed icon the item asks the host to draw: the one the package
/// installs (`hicolor/scalable/apps/org.tunaos.compass.svg`).
pub const ICON_NAME: &str = "org.tunaos.compass";
...
const SETTINGS_LINK: &str = "compass://settings/open";
...
mod tests {
    ...
    fn the_settings_entries_open_the_settings_view_by_its_deeplink() {
        assert_eq!(settings_link(None), "compass://settings/open");
        assert_eq!(
            settings_link(Some("about")),
            "compass://settings/open?tab=about"
        );
    ...
    fn the_menu_is_the_models_with_its_labels_and_actions() {
        ...
        assert_eq!(
            ...
            [
                ...
                None,
                Some("Sponsor Upstream Vicinae".to_owned()),
                Some("Compass on GitHub".to_owned()),
                None,
