//! The file-indexer service: JSON-RPC over stdio, like `vicinae-file-indexer`.
//!
...
/// The database file under a cache home: `<cache>/vicinae/file-indexer/`
...
/// write-ahead logs: `<data>/vicinae/file-indexer.db` and
/// `<data>/vicinae/file-indexer/file-indexer.db`.
///
