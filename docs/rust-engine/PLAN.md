...
the phase is 14 of 49 API methods and none of its gate. The rest is 226 unported
...
| `Application`, `WindowManagement`, `Command`, `Wallpaper`, `BrowserExtension` | **not started**; 19 methods, most of which are a thin call into a service Phase 5 also needs |
